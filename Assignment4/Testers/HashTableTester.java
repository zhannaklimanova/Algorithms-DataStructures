...
public class HashTableTester {
    ...
    private static ArrayList<Tweet> initTweetList() {
        ArrayList<Tweet> tweets = new ArrayList<Tweet>(); // 26 tweets
        tweets.add(new Tweet("USER_989b85bb","2010-03-04 15:34:47","I can be MADE into a need."));
        tweets.add(new Tweet("USER_989b85bb","2010-03-05 15:34:46","@USER_6921e61d I can be made into one twitter superstar."));
//        tweets.add(new Tweet("USER_989b85bb","2010-03-04 15:34:46","@USER_6921e61d I AM A COPY.")); // replaces the one above 
        ...
        tweets.add(new Tweet("USER_b7117680","2010-03-03 06:55:17","I got a hustlas spirit, period!")); // removed if remove function is called
       
//        tweets.add(new Tweet("USER_86c542b8","2010-08-04 02:52:06","Let's hope I finally fixed that BUG!!!!!!!"));
    ...
    private static ArrayList<Tweet> initTweetList2() {
        ArrayList<Tweet> tweets = new ArrayList<Tweet>(); // 26 tweets
        tweets.add(new Tweet("USER_989b85bb","2010-03-04 15:34:46","@USER_6921e61d I can be made into one twitter superstar."));
        tweets.add(new Tweet("USER_989b85bb","2010-03-04 15:34:46","@USER_6921e61d I AM A COPY."));
        
        tweets.add(new Tweet("USER_a75657c2","2010-03-03 00:02:54","@USER_13e8a102 They reached a compromise just on time"));
        tweets.add(new Tweet("USER_989b85bb","2010-03-04 15:34:47","I can be MADE into a need."));
        tweets.add(new Tweet("USER_989b85bb","2010-03-00 15:34:47","I can be MADE into a need."));
        tweets.add(new Tweet("USER_a75657c2","2010-03-07 21:45:48","So SunChips made a bag that is 100% biodegradeable. It is about damn time somebody did."));
        tweets.add(new Tweet("USER_ee551c6c","2010-03-07 15:40:27","drthema: Do something today that feeds your spirit and empowers you to start the week from a higher place."));
        tweets.add(new Tweet("USER_6c78461b","2010-03-03 05:13:34","@USER_a3d59856 yes, i watched that foolery done disturbed my spirit. @USER_b1d28f26"));
        tweets.add(new Tweet("USER_92b2293c","2010-03-04 14:00:11","@USER_5aac9e88: Let no one push u around today! Be at Peace! If u dont have restful spirit, u'll definitely have a stressful spirit"));
        ...
        tweets.add(new Tweet("USER_7f72a368","2010-03-07 07:18:22","Actions speak louder than words but feelings and spirits speak louder than anything #FACT"));
        tweets.add(new Tweet("USER_b6cc1831","2010-03-07 04:04:37","@USER_be777094 urban spirit cafe. On Long st"));
        tweets.add(new Tweet("USER_b6cc1831","2010-03-09 04:04:37","@USER_be777094 urban spirit cafe. On Long st"));
        tweets.add(new Tweet("USER_65006b55","2010-03-05 00:58:28","RT @USER_86e8d97f: @USER_65006b55's spirit just took a turn for the worst. Lol please."));
        tweets.add(new Tweet("USER_60b9991b","2010-03-04 22:33:23","Who on my time ever flew on spirit airlines let me kno if there decent"));
        tweets.add(new Tweet("USER_36607a99","2010-03-03 02:06:01","@USER_561fe280: Nourish your spirit with your own achievement."));
        tweets.add(new Tweet("USER_9506fb5f","2010-03-04 01:16:34","Great spirits have often encountered violent opposition from weak minds"));
        ...
        tweets.add(new Tweet("USER_5d246e83","2010-03-04 14:57:01","@USER_8e090edb That's always good to hear. Starting off to a good morning, always puts your spirit in a great place."));
        tweets.add(new Tweet("USER_1e4eb302","2010-03-03 20:13:18","Anything worth having you have to contribute yourself heart, mind, soul and spirit to. It is so rewarding. Have u contributed lately?"));
        tweets.add(new Tweet("USER_b7117680","2010-03-03 06:55:17","I got a hustlas spirit, period!")); // removed after remove is called
       
        tweets.add(new Tweet("USER_25ecff25","2010-03-05 17:33:20","RT @USER_3a117437: The woman at the rental car spot tried 2 give us a Toyota! No ma'am lk the old spiritual says \"aint got time 2 die!\""));   
        tweets.add(new Tweet("USER_f91d8165","2010-03-03 22:33:24","#RandomThought why do people grab guns or knives when they think theres a ghost? DUMBASS! You can't shoot a spirit, grab some holy water! duh"));
        tweets.add(new Tweet("USER_86c542b8","2010-03-04 02:52:06","@USER_8cd1512d haha, maybe your right. I use to watch gymnastics all the time. I love the olympics. That's why I have so much spirit lol"));
        tweets.add(new Tweet("USER_86c542b8","2010-03-05 02:52:06","@USER_8cd1512d haha, maybe your right. I use to watch gymnastics all the time. I love the olympics. That's why I have so much spirit lol"));
...
//        ArrayList<Tweet> tweets = initTweetList2();
//        MyHashTable<String,String> tweetTable;
//        int numBuckets = 7;
//        // Initialize the hash table. Key will be the tweet dateAndTime. Value will be the tweet message.
//      // Both key and value are Strings
//        
//        tweetTable = new MyHashTable<String, String>(numBuckets);
//        for (Tweet t: tweets) {
//            tweetTable.put(t.getDateAndTime(), t.getMessage());
//        }
//        
...
//        for (LinkedList<HashPair<String, String>> l: tweetTable.getBuckets()) {
//          for (HashPair<String,String> h: l) {
//              System.out.println(h.getKey().toString());
//              System.out.println(h.getValue().toString());
//          }
//        }
//
//        System.out.println("\n---------------\nTesting values:\n---------------\n");
//        System.out.println("tweetTable size" + tweetTable.size());
//        int i = 0;
//        tweetTable.values();
//        for (String value: tweetTable.values()) {
//          System.out.println(value.toString());
//          i++;
//        }
//        System.out.println("i is " + i + " " + "tweetTable previous size " + tweetTable.size());
//        
//    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("Number of buckets in the table: " + tweetTable.numBuckets());
        System.out.println(tweetTable);
        for (LinkedList<HashPair<String, Tweet>> l: tweetTable.getBuckets()) {
            for (HashPair<String,Tweet> h: l) {
                System.out.println(h.getKey().toString());
                System.out.println(h.getValue().toString());
            }
        }
...
//        }
        ...
        System.out.println("numEntries before " + tweetTable.size());
        ...
        System.out.println("numEntries after " + tweetTable.size());
        ...
        System.out.println("tweetTable size" + tweetTable.size());
        int counter = 0;
        for (String key: tweetTable.keys()) {
            System.out.println(key);
            counter++;
        }
        System.out.println("counter " + counter + " " + "tweetTable size " + tweetTable.size());
        
        
        System.out.println("\n---------------\nTesting values:\n---------------\n");
        /*
        * To test values go up to the second main statement above. 
        */
        ...
        ArrayList<String> slowSorted = MyHashTable.slowSort(tweetTable);
        for (String pair: slowSorted) {
        ...
        ArrayList<String> fastSorted = MyHashTable.fastSort(tweetTable);
        for (String pair: fastSorted) {
            System.out.println(pair.toString());
        }
        
        System.out.println("COMPARING fastSort to slowSort");
        if (slowSorted.equals(fastSorted)) {
        ...
        inFile = new Scanner(new File("stopWords.txt"));
        while (inFile.hasNext()) {
            stopWords.add(inFile.nextLine());
        }
        
        Twitter t = new Twitter(initTweetList(), stopWords);
       
        System.out.println("\n---------------\nTesting addTweet:\n---------------\n");
        Tweet newTweet = new Tweet("zklimanova", "2020-08-24", "This is my final test.");
        t.addTweet(newTweet);
        ...
        if ((tweetByAuthor == null) || (!tweetByAuthor.getAuthor().equals("USER_989b85bb") && 
                !tweetByAuthor.getMessage().equals("@USER_6921e61d I can be made into one twitter superstar.") &&
                !tweetByAuthor.getDateAndTime().equals("2010-03-05 15:34:46"))) {
        ...
        Tweet tweetByAuthor2 = t.latestTweetByAuthor("USER_a75657c2");
        if ((tweetByAuthor2 == null) || (!tweetByAuthor2.getAuthor().equals("USER_a75657c2") && 
                !tweetByAuthor2.getMessage().equals("So SunChips made a bag that is 100% biodegradeable. It is about damn time somebody did.") &&
                !tweetByAuthor2.getDateAndTime().equals("2010-03-07 21:45:48"))) {
            errors.append("Failer to retrieve the latest tweet by USER_a75657c2\n");
        }
        System.out.println("Latest tweet by USER_a75657c2 :" + tweetByAuthor2);
         
        Tweet tweetByAuthor3 = t.latestTweetByAuthor("USER_86c542b8");
        if ((tweetByAuthor3 == null) || (!tweetByAuthor3.getAuthor().equals("USER_86c542b8") && 
                !tweetByAuthor3.getMessage().equals("Let's hope I finally fixed that BUG!!!!!!!") &&
                !tweetByAuthor3.getDateAndTime().equals("2010-08-04 02:52:06"))) {
            errors.append("Failer to retrieve the latest tweet by USER_86c542b8\n");
        }
        System.out.println("Latest tweet by USER_86c542b8 :" + tweetByAuthor3);
        
        Tweet tweetByAuthor4 = t.latestTweetByAuthor("zklimanova");
        if ((tweetByAuthor4 == null) || (!tweetByAuthor4.getAuthor().equals("zklimanova") && 
                !tweetByAuthor4.getMessage().equals("This is my final test.") &&
                !tweetByAuthor4.getDateAndTime().equals("2020-08-24"))) {
            errors.append("Failer to retrieve the latest tweet by USER_86c542b8\n");
        }
        System.out.println("Latest tweet by USER_86c542b8 :" + tweetByAuthor4);
        ...
        ArrayList<Tweet> tweetsByDate2 = t.tweetsByDate("2010-03-04");
        if(tweetsByDate2.size() != 7){
            errors.append("Failed to retrieve all 7 tweets posted on 2010-03-04\n");
        } 
        System.out.println(tweetsByDate2.size() + " tweets posted on 2010-03-04 :");
        tweetsByDate2.forEach(tweet -> System.out.println("\t" + tweet));
        
        ArrayList<Tweet> tweetsByDate3 = t.tweetsByDate("2010-03-05");
        if(tweetsByDate3.size() != 4){
            errors.append("Failed to retrieve all 7 tweets posted on 2010-03-05\n");
        } 
        System.out.println(tweetsByDate3.size() + " tweets posted on 2010-03-05 :");
        tweetsByDate3.forEach(tweet -> System.out.println("\t" + tweet));
        
        
        
        System.out.println("\n---------------\nTesting trendingTopics:\n---------------\n");
        ArrayList<String> allWords = t.trendingTopics();
        int countWords = 1;
        for (String word: allWords) {
            System.out.println(countWords + "    " + word.toString());
            countWords++;
        }
